...
def create_data_source_via_rest(data_source_name, search_service_endpoint, credential, storage_account_resource_id, container_name, user_assigned_identity_resource_id):
    ...
    data_source_definition = {
        ...
        "identity": {
            "userAssignedIdentity": user_assigned_identity_resource_id
        } if user_assigned_identity_resource_id else None
    }
    # Remove identity if not set
    if not user_assigned_identity_resource_id:
        data_source_definition.pop("identity")
...
for container in containers:
    ...
    if not create_data_source_via_rest(data_source_name, search_service_endpoint, credential, storage_account_resource_id, container, user_assigned_identity_resource_id):
